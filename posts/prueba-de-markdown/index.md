...
Este post está basado en [https://daringfireball.net/projects/markdown/syntax](https://daringfireball.net/projects/markdown/syntax) y corresponde a una traducción practicamente literal de una selección de su contenido. Todo el crédito corresponde a su autor, John Gruber.

La idea es contar con un resumen del código markdown, y a partir de un archivo con múltiples markups de markdown, verificar la correcta interpretación del código markdown por nikolas.
